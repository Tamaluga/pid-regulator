...
#include "pidautotuner.h" /* Include Headerfile */
#include <math.h>
...
static float targetInputValue = 0;
static float loopInterval = 0;
static float minOutput, maxOutput;
static ZNMode znMode = ZNModeBasicPID;
...
static long us = 0;
static long microseconds, t1, t2, tHigh, tLow;
static float max, min;
static float pAverage, iAverage, dAverage;
